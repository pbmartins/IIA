...
########################
# Inserted by me
# Test case on getAssocTypes()
#z.insert('descartes',Association('homem','pulsacao','numero','one'))
###########################
# Test case on getObjectsType()
#z.insert('descartes',Association('platao','altura',1.2))
#z.insert('descartes',Association('homem','peso','numero','one'))
#z.insert('descartes',Association('platao','peso',1.2))
###########################
#z.insert('tracker',Association('agent','at','cell','one',(0,0)))
########################
